  ...
  },
  {
    ...
    variables: [
      ...
      },
      {
        name: '--box-shadow',
        label: 'Box Shadow',
        value: '0 28px 48px rgba(0,0,0,0.4)',
        type: 'text',
        defaultValue: '0 28px 48px rgba(0,0,0,0.4)',
      },
    ],
  },
  {
    ...
    variables: [
      ...
      },
      {
        name: '--box-shadow',
        label: 'Box Shadow',
        value: '0 5px 20px rgba(0,0,0,0.15)',
        type: 'text',
        defaultValue: '0 5px 20px rgba(0,0,0,0.15)',
      },
      {
        name: '--min-width',
        label: 'Min Width',

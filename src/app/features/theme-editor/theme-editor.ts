...
@Component({
  ...
  template: `
    <div class="h-screen flex flex-col bg-gray-50">
      <!-- Header -->
      <header
        class="bg-white border-b border-gray-200/80 px-6 py-3 flex items-center justify-between shrink-0 shadow-sm"
      >
        <div class="flex items-center gap-3">
          ...
          <span
            class="text-[10px] font-bold bg-indigo-50 text-indigo-600 px-2 py-0.5 rounded-full uppercase tracking-wide"
          >
            v8+
          </span>
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex items-center bg-gray-100 rounded-xl p-1 shadow-inner">
            <button
              ...
              [class]="
                themeService.previewPlatform() === 'ios'
            ...
            <button
              ...
              class="px-3 py-1.5 text-xs font-semibold rounded-lg transition-all cursor-pointer"
              [class]="
                themeService.previewPlatform() === 'md'
                  ? 'bg-white text-gray-900 shadow-sm'
                  : 'text-gray-500 hover:text-gray-700'
              "
          ...
          <span class="text-xs text-gray-400 font-medium"> {{ componentCount() }} components </span>
          <button
            type="button"
...
export class ThemeEditorComponent {
  ...
  protected readonly componentCount = computed(() => this.themeService.componentThemes().length);
}
